# '''此代码用于画box_loss曲线并以高分辨率保存，使用新罗马字体'''
# import pandas as pd
...
# plt.title('Validation Box Loss over Epochs', fontsize=14)
...
#
# # 保存图像
# plt.savefig('LossCurve/Validation_Box_Loss.png', dpi=600, bbox_inches='tight')
#
# # 显示图像（可选）
# plt.show()

'''此代码用于画box_loss曲线并以高分辨率保存，使用系统默认衬线字体'''
import pandas as pd
import matplotlib.pyplot as plt
import glob
import os
