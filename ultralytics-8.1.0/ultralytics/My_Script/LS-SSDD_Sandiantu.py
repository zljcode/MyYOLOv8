...
# 设置x轴和y轴的范围和刻度间隔
plt.xlim(-0.01, 0.11)  # 设置x轴范围为-0.01到0.11
plt.ylim(-0.01, 0.11)  # 设置y轴范围为-0.01到0.11
plt.xticks(ticks=np.arange(0, 0.11, 0.02), fontsize=12)  # x轴刻度间隔为0.02，字号为12
plt.yticks(ticks=np.arange(0, 0.11, 0.02), fontsize=12)  # y轴刻度间隔为0.02，字号为12
