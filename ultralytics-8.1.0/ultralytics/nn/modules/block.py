...
__all__ = (
    ...
    'C2f_CA', 'C2f_SE', 'C2f_ECA', 'C2f_CBAM', 'C2f_SimAM', 'C2f_CoT', 'C2f_Double',
    'C2f_SK', 'C2f_EffectiveSE', 'C2f_GlobalContext', 'C2f_GatherExcite', 'C2f_MHSA',
...
class C2f_CBAM(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):  # ch_in, ch_out, number, shortcut, groups, expansion
        ...
        self.m = nn.ModuleList(
            CBAM_Bottleneck(self.c, self.c, shortcut, g, k=((3, 3), (3, 3)), e=1.0) for _ in range(n))
...
class C2f_Double(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):  # ch_in, ch_out, number, shortcut, groups, expansion
        ...
        self.cv2 = Conv((2 + n) * self.c, c2, 1)  # optional act=FReLU(c2)
        self.m = nn.ModuleList(
            Double_Bottleneck(self.c, self.c, shortcut, g, k=((3, 3), (3, 3)), e=1.0) for _ in range(n))
